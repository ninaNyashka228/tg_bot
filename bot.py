...
# Запускаем веб-сервер в фоновом потоке (не блокирует основную работу бота)
...
#  Загрузка отраслевых данных (из папки industry_data)
print("=" * 60)
...
# Используем постоянное хранилище /data (на Koyeb) для сохранения истории
...
#  Обучение модели (один раз при запуске)
print("\n" + "=" * 60)
